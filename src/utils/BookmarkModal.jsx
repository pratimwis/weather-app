...
const BookmarkModal = ({ isOpen, setIsOpen }) => {
            ...
            <div className="relative z-10">
              <div className="text-left p-4 mb-10 space-y-4">
                {bookmarks && bookmarks.length > 0 ? (
                  bookmarks.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 sm:gap-4 mt-3 sm:mt-0 w-full sm:w-auto justify-between sm:justify-end">
                        ...
                        />
                        {/* <span className="text-sm sm:text-base font-medium text-white/80 text-right sm:text-left">
                  ...
                  <div className="text-center text-white/60 py-8">No Bookmark list found.</div>
                )}
              </div>
